...
function callActivate(address biomeWorldAddress, address delegatorAddress, address player) {
  bytes memory activateCallData = abi.encodeCall(IActivateSystem.activatePlayer, (player));
